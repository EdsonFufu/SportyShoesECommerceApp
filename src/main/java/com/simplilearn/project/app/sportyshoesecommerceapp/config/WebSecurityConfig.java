...
//    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers("/product","user","category","payment","address","order").hasAnyRole("ROLE_USER", "ROLE_ADMIN")
                .antMatchers("/product/add").hasAnyRole("ROLE_ADMIN").anyRequest().authenticated()
                .and()
                    .formLogin()
                    //.loginPage("/login")
                    .failureUrl("/login?error=true").defaultSuccessUrl("/").usernameParameter("username").passwordParameter("password")
                    .permitAll()
                .and()
